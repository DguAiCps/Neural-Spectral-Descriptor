...
code-release source of truth is:
...
3. `RELEASE_CHECKLIST.md` — final checks before sharing the code.

The manuscript source (`body_v1.3/neurips_2026.tex`) is maintained in the
parent paper workspace and is not part of this code-only archive.
